...
{
	return DefaultEquals<T>( src, dest, flags );
}
...
template< class T >
void Print( DataPointer pointer, String& string, ObjectIdentifier& identifier)
{
	const Enumeration* enumeration = T::s_Enumeration;
	tstring str;
...
template< class T >
void Parse( const String& string, DataPointer pointer, ObjectResolver& resolver, bool raiseChanged )
{
	const Enumeration* enumeration = T::s_Enumeration;
	tstring str = string;
